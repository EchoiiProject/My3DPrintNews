...
export const verticals: Vertical[] = [
  ...
  {
    id: "myliverpoolnews",
    name: "MyLiverpoolNews",
    slug: "myliverpoolnews",
    publicationName: "MyLiverpoolNews",
    publicationDescription:
      "Local news, business, transport, culture, events, and city updates for Liverpool.",
    publicationSlug: "myliverpoolnews",
    publicationType: "place",
    defaultCollections: [
      "News",
      "Business",
    ...
    hostname: "myliverpoolnews.mynewsnetwork.uk",
    visibility: "demo",
    publicationStatus: "draft",
    autoFetchEnabled: true,
    showInDiscover: true,
    ...
    domain: "myliverpoolnews.example.com",
    description:
      "Proof-of-concept place-based publication for Liverpool readers.",
    sector: "Place-based local news",
    status: "active",
    relatedVerticalIds: [],
    publicUrl: "/publications/myliverpoolnews",
    subscriberCount: 0,
    comingSoon: false,
    logo: "LN",
    ownerName: "Demo Platform Owner",
  ...
  },
  {
    ...
    hostname: "myprestonnews.mynewsnetwork.uk",
    visibility: "demo",
    publicationStatus: "draft",
    autoFetchEnabled: true,
    showInDiscover: true,
    ...
    showFeedback: true,
    primaryColour: "#475569",
    domain: "myprestonnews.example.com",
    description:
      "Proof-of-concept place-based publication for Preston readers.",
    sector: "Place-based local news",
    status: "active",
    relatedVerticalIds: [],
    publicUrl: "/publications/myprestonnews",
    subscriberCount: 0,
    comingSoon: false,
    logo: "PN",
    ownerName: "Demo Platform Owner",
...
export const publicationSlugByAdminSlug: Record<string, string> = {
  ...
  myliverpoolnews: "myliverpoolnews",
  myprestonnews: "myprestonnews",
};
