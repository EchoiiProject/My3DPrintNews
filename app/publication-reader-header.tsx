...
export function PublicationReaderHeader({
  ...
  return (
    <header className="rounded-lg border-2 border-blue-600 bg-white p-5 shadow-xl shadow-blue-950/15">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <nav className="flex flex-wrap gap-2 rounded-lg border border-blue-100 bg-blue-50 p-2">
          {navigation.map((item) =>
            item.href ? (
              <Link
                className={[
                  "inline-flex min-h-11 items-center justify-center rounded-md border px-4 text-sm font-black",
