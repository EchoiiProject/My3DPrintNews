  ...
  return (
    <div className="space-y-8">
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ["Total configured sources", diagnostics.totalConfiguredSources],
          ["Enabled sources", diagnostics.enabledSources],
          ["Healthy sources", diagnostics.healthySources],
          ["No recent articles", diagnostics.sourcesWithNoRecentArticles],
          ["Total articles collected", diagnostics.totalArticlesCollected],
          ["Newest article", formatDate(diagnostics.newestArticle)],
          ["Oldest article", formatDate(diagnostics.oldestArticle)],
          ["Zero article feeds", diagnostics.zeroArticleSources.length],
        ].map(([label, value]) => (
          <div
              ...
              {sources.map((source) => (
                <tr key={source.id}>
                  ...
                  <td className="px-4 py-3 text-slate-600">
                    ...
                    <p className="text-xs">Last article: {formatDate(source.lastArticleDate)}</p>
                  </td>
                  <td className="px-4 py-3 font-bold text-slate-900">
